...
import { LinqAPIV3, ClientOptions } from '@linqapp/sdk';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: LinqAPIV3)`
    : `const run: (${functionSource.client}: LinqAPIV3) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.chats.create',
    'client.chats.leaveChat',
    'client.chats.listChats',
    'client.chats.markAsRead',
    'client.chats.retrieve',
    'client.chats.sendVoicememo',
    'client.chats.shareContactCard',
    'client.chats.update',
    'client.chats.participants.add',
    'client.chats.participants.remove',
    ...
    'client.phoneNumbers.getReputationAudit',
    'client.phoneNumbers.list',
    'client.phoneNumbers.startReputationAudit',
    ...
    'client.paymentProviders.connect',
    'client.paymentProviders.retrieve',
    'client.paymentHandles.connect',
    'client.paymentHandles.connection',
    'client.paymentHandles.revoke',
    'client.paymentHandles.verify',
    'client.payments.cancel',
    'client.payments.create',
    'client.payments.credentials',
    'client.payments.retrieve',
    'client.blockedHandles.block',
    'client.blockedHandles.list',
    'client.blockedHandles.unblock',
