...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  {
    name: 'set',
    endpoint: '/v3/chats/{chatId}/background',
    httpMethod: 'post',
  ...
  },
  {
    ...
    description: 'Remove the transcript background from a chat, resetting it to the default.\n',
    stainlessPath: '(resource) chats.background > (method) remove',
    qualified: 'client.chats.background.remove',
    params: ['chatId: string;'],
    markdown:
  ...
  {
    name: 'update_sticker_placement',
    endpoint: '/v3/messages/{messageId}/reactions/{reactionId}',
    httpMethod: 'patch',
    summary: 'Move a sticker already on a message',
    description:
    ...
    stainlessPath: '(resource) messages > (method) update_sticker_placement',
    qualified: 'client.messages.updateStickerPlacement',
    params: [
      'messageId: string;',
      'reactionId: string;',
      'placement: { rotation?: number; scale?: number; x?: number; y?: number; };',
  ...
  {
    name: 'start_reputation_audit',
    endpoint: '/v3/phone_numbers/{phoneNumber}/reputation_audit',
    httpMethod: 'post',
    summary: 'Start a line reputation audit',
    description:
  ...
  {
    name: 'get_reputation_audit',
    endpoint: '/v3/phone_numbers/{phoneNumber}/reputation_audit/{auditId}',
    httpMethod: 'get',
    summary: 'Get a line reputation audit',
    description:
    ...
    stainlessPath: '(resource) phone_numbers > (method) get_reputation_audit',
    qualified: 'client.phoneNumbers.getReputationAudit',
    params: ['phoneNumber: string;', 'auditId: string;'],
    response:
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://api.linqapp.com/api/partner/v3/phone_numbers/$PHONE_NUMBER/reputation_audit/$AUDIT_ID \\\n    -H "Authorization: Bearer $LINQ_API_V3_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      '{ subscriptions: { id: string; created_at: string; is_active: boolean; subscribed_events: webhook_event_type[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }[]; }',
    markdown:
      "## list\n\n`client.webhookSubscriptions.list(): { subscriptions: webhook_subscription[]; }`\n\n**get** `/v3/webhook-subscriptions`\n\nRetrieve all webhook subscriptions for the authenticated partner.\nReturns a list of active and inactive subscriptions with their\nconfiguration and status.\n\n\n### Returns\n\n- `{ subscriptions: { id: string; created_at: string; is_active: boolean; subscribed_events: webhook_event_type[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }[]; }`\n\n  - `subscriptions: { id: string; created_at: string; is_active: boolean; subscribed_events: string[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }[]`\n\n### Example\n\n```typescript\nimport LinqAPIV3 from '@linqapp/sdk';\n\nconst client = new LinqAPIV3();\n\nconst webhookSubscriptions = await client.webhookSubscriptions.list();\n\nconsole.log(webhookSubscriptions);\n```",
    perLanguage: {
      go: {
  ...
  },
  {
    ...
    response:
      '{ id: string; created_at: string; is_active: boolean; subscribed_events: string[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }',
    markdown:
      "## retrieve\n\n`client.webhookSubscriptions.retrieve(subscriptionId: string): { id: string; created_at: string; is_active: boolean; subscribed_events: webhook_event_type[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }`\n\n**get** `/v3/webhook-subscriptions/{subscriptionId}`\n\nRetrieve details for a specific webhook subscription including its\ntarget URL, subscribed events, and current status.\n\n\n### Parameters\n\n- `subscriptionId: string`\n\n### Returns\n\n- `{ id: string; created_at: string; is_active: boolean; subscribed_events: string[]; target_url: string; updated_at: string; environment_id?: string; phone_numbers?: string[]; }`\n\n  - `id: string`\n  - `created_at: string`\n  - `is_active: boolean`\n  - `subscribed_events: string[]`\n  - `target_url: string`\n  - `updated_at: string`\n  - `environment_id?: string`\n  - `phone_numbers?: string[]`\n\n### Example\n\n```typescript\nimport LinqAPIV3 from '@linqapp/sdk';\n\nconst client = new LinqAPIV3();\n\nconst webhookSubscription = await client.webhookSubscriptions.retrieve('b2c3d4e5-f6a7-8901-bcde-f23456789012');\n\nconsole.log(webhookSubscription);\n```",
    perLanguage: {
      go: {
