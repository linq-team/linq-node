...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    response:
      "{ chat: { id: string; display_name: string; handles: object[]; is_group: boolean; message: object; service: 'iMessage' | 'SMS' | 'RCS'; health_score?: { reason: string; score: number; updated_at: string; }; }; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; display_name: string; handles: { id: string; handle: string; joined_at: string; service: service_type; is_me?: boolean; left_at?: string; status?: 'active' | 'left' | 'removed'; }[]; is_archived: boolean; is_group: boolean; updated_at: string; health_score?: { reason: string; score: number; updated_at: string; }; service?: 'iMessage' | 'SMS' | 'RCS'; }",
    markdown:
