...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.messages.poll.options.create',
    fullyQualifiedName: 'messages.poll.options.create',
    httpMethod: 'post',
    httpPath: '/v3/messages/{messageId}/poll/options',
  },
  {
    clientCallName: 'client.messages.poll.votes.create',
    fullyQualifiedName: 'messages.poll.votes.create',
    httpMethod: 'post',
