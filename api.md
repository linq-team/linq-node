...
- <code title="get /v3/messages/{messageId}/poll">client.messages.poll.<a href="./src/resources/messages/poll/poll.ts">retrieve</a>(messageID) -> PollEnvelope</code>

### Options

Methods:

- <code title="post /v3/messages/{messageId}/poll/options">client.messages.poll.options.<a href="./src/resources/messages/poll/options.ts">create</a>(messageID, { ...params }) -> PollEnvelope</code>

### Votes

Methods:

- <code title="post /v3/messages/{messageId}/poll/votes">client.messages.poll.votes.<a href="./src/resources/messages/poll/votes.ts">create</a>(messageID, { ...params }) -> PollEnvelope</code>
