...
import { OptionCreateParams, Options } from './options';
import * as VotesAPI from './votes';
import { VoteCreateParams, Votes } from './votes';
...
export declare namespace Poll {
  export { Options as Options, type OptionCreateParams as OptionCreateParams };

  export { Votes as Votes, type VoteCreateParams as VoteCreateParams };
}
